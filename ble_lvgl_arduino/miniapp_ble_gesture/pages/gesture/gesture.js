...
// 映射规则：
//   PWM=1000/1800 → CH输入=500（<650 → pwm_manager自动出高档）
//   PWM=2000/1350 → CH输入=1000（>650 → pwm_manager自动出低档）
//   CH6 由CH1自动派生（不需小程序手动设），CH7~CH11 固定1500
// ============================================================
const GESTURES = [
  {
    name: '1',    image: '/images/1.png',
    // PWM目标: 1000 2000 1000 1000 1000 1800 → CH2=高档1800
    ch: [1000,500,1000,1000,1000, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '1000 2000 1000 1000 1000 1800'
  },
  {
    name: '2',    image: '/images/2.png',
    // PWM目标: 1000 2000 2000 1000 1000 1800 → CH2/3=高档1800
    ch: [1000,500,500,1000,1000, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '1000 2000 2000 1000 1000 1800'
  },
  {
    name: '3',    image: '/images/3.png',
    // PWM目标: 1000 1000 2000 2000 2000 1800 → CH2/3/4=高档
    ch: [1000,500,500,500,1000, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '1000 2000 2000 2000 1000 1800'
  },
  {
    name: '4',    image: '/images/4.png',
    // PWM目标: 1000 2000 2000 2000 2000 1800 → CH1=低档
    ch: [1000,500,500,500,500, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '1800 1000 2000 2000 2000 1800'
  },
  {
    name: '5',    image: '/images/5.png',
    // PWM目标: 2000 2000 2000 2000 2000 1350 → CH1~5=全高档
    ch: [500,500,500,500,500, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '2000 2000 2000 2000 2000 1350'
  },
  {
    name: '6',    image: '/images/6.png',
    // PWM目标: 2000 2000 1000 1000 1000 1350 → CH1/5=高档
    ch: [500,1000,1000,1000,500, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '2000 1000 1000 1000 2000 1350'
  },
  {
    name: '7',    image: '/images/7.png',
    // PWM目标: 2000 2000 2000 1000 1000 1350 → CH3/4=低档
    ch: [500,500,500,1000,1000, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '2000 2000 2000 1000 1000 1350'
  },
  {
    name: '8',    image: '/images/8.png',
    // PWM目标: 2000 2000 1000 1000 1000 1350 → CH1/2=高档
    ch: [500,500,1000,1000,1000, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '2000 2000 1000 1000 1000 1350'
  },
  {
    name: '10',   image: '/images/10.png',
    // PWM目标: 1000 1000 1000 1000 1000 1800 → CH1~5=全低档
    ch: [1000,1000,1000,1000,1000, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '1000 1000 1000 1000 1000 1800'
  },
  {
    name: 'ok',   image: '/images/ok.png',
    // PWM目标: 1000 1000 2000 2000 2000 1800 → CH1/2=低档
    ch: [1000,1000,500,500,500, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '1000 1000 2000 2000 2000 1800'
  },
  {
    name: 'good', image: '/images/good.png',
    // PWM目标: 2000 1000 1000 1000 1000 1350 → CH1=高档
    ch: [500,1000,1000,1000,1000, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '2000 1000 1000 1000 1000 1350'
  },
  {
    name: 'love', image: '/images/love.png',
    // PWM目标: 2000 2000 1000 1000 2000 1350 → CH3/4=低档
    ch: [500,500,1000,1000,500, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '2000 2000 1000 1000 2000 1350'
  }
];

// 初始姿态（s_gesture_rest_pose 修正版：1350,2000,2000,2000,2000,2000 → 全高档CH1~5=2000）
const RESET_CH = [500,500,500,500,500, 1500,1500,1500,1500,1500,1500];
const RESET_SUMMARY = '500 500 500 500 500 1350';
const DEFAULT_SUMMARY = '---- ---- ---- ---- ---- ----';
// 急停数据帧：CH1~5=650（恰好=阈值650 → ESP32 输出中档1500us），CH6由CH1派生→1800us
...
Page({
  ...
  //           ESP32 按正常CH映射输出（650≤阈值→CH1~5=1000us, CH6=1800us）
  //           本地按钮变深红+黄边，文字"恢复按钮"
