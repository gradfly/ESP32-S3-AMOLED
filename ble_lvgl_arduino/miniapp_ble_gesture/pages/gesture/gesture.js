...
// 映射规则：
//   PWM=1000/1400 → CH输入=1500（≤650 → pwm_manager自动出低档）
//   PWM=2000/1750 → CH输入=1800（>650 → pwm_manager自动出高档）
...
const GESTURES = [
  ...
  },
  {
    ...
    ch: [1000,1000,1000,500,500, 1500,1500,1500,1500,1500,1500],
  ...
  },
  {
    ...
    ch: [1000,1000,500,500,1000, 1500,1500,1500,1500,1500,1500],
    pwmSummary: '2000 2000 1000 1000 2000 1750'
  }
];

// 初始姿态（s_gesture_rest_pose 修正版：1750,2000,2000,2000,2000,2000 → 全高档CH1~5=1800）
